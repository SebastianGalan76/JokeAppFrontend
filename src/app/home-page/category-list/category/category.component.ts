...
export class CategoryComponent {
  ...
  constructor(private categoryService: CategoryService, private userService:UserService, private notificationService: NotificationService, private router: Router) { }
    ...
    this.userService.getUser().subscribe({
      next: (user) => {
        if(user){
          ...
          this.notificationService.showNotification('Musisz się zalogować, aby dodawać kategorie do ulubionych', NotificationType.ERROR);
        }
      }
    })
  }

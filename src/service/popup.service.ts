...
import { ConfirmActionComponent } from '../app/shared/popup/confirm-action/confirm-action.component';
...
export class PopupService {
  ...
  showConfirmPopup(data?: any[]): Observable<any> {
    ...
    if (this.popupContainer) {
      this.popupContainer.clear();
      const componentRef: ComponentRef<ConfirmActionComponent> = this.popupContainer.createComponent(ConfirmActionComponent);
      ...
      const instance = componentRef.instance as ConfirmActionComponent;
